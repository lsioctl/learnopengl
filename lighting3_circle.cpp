...
int main()
{
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        // Let the light circle around
        const float light_circle_radius{0.9f};
        auto light_pos_x = sin(glfwGetTime()) * light_circle_radius;
        auto light_pos_y = 0.;
        auto light_pos_z = cos(glfwGetTime()) * light_circle_radius;

        auto light_source_position = glm::vec3(light_pos_x, light_pos_y, light_pos_z);
